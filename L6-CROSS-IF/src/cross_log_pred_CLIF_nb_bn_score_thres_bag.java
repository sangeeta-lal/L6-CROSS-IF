...
// 2. It uses threshold 
// 3. It uses bagging
public class cross_log_pred_CLIF_nb_bn_score_thres_bag
{
...
String source_file_path = path+"L6-CROSS-IF\\dataset\\"+source_project+"-arff\\"+type+"\\"+source_project+"_to_"+ source_project+type+"_all_features.arff";		
...
{	  	
	  ...
	  cross_log_pred_CLIF_nb_bn_score_thres_bag clps =  new cross_log_pred_CLIF_nb_bn_score_thres_bag();
