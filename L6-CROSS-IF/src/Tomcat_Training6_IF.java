...
public class Tomcat_Training6_IF
{
	...
	String table ="tomcat_if_training6_crossif";
    String listing_file_path = "E:\\Sangeeta\\Research\\L6-CROSS-IF\\result\\tomcat-8.0.9_java_files.txt"; 
    
    String non_logged_file_path = "E:\\Sangeeta\\Research\\L6-CROSS-IF\\result\\tomcat_non_log_if.txt";
   ...
   //*/
	...
	{				    
		Tomcat_Training6_IF demo = new Tomcat_Training6_IF();
...
public void ast_prser(String file_name)
	{
		try
		{
			...
			rawContent = Tomcat_Training6_IF.readFileToString(file_name);
