...
String source_num_file_path = path+"L6-CROSS-IF\\dataset\\"+source_project+"-arff\\"+type+"\\num-features\\"+source_project+"_"+type+"_num_features.arff";		
String target_num_file_path = path+"L6-CROSS-IF\\dataset\\"+target_project+"-arff\\"+type+"\\num-features\\"+target_project+"_"+type+"_num_features.arff";

String source_bool_file_path = path+"L6-CROSS-IF\\dataset\\"+source_project+"-arff\\"+type+"\\bool-features\\"+source_project+"_"+type+"_bool_features.arff";		
String target_bool_file_path = path+"L6-CROSS-IF\\dataset\\"+target_project+"-arff\\"+type+"\\bool-features\\"+target_project+"_"+type+"_bool_features.arff";
