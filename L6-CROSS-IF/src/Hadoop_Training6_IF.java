...
public class Hadoop_Training6_IF
{
	...
	String table ="hd_if_training6_crossif";
    String listing_file_path = "E:\\Sangeeta\\Research\\L6-CROSS-IF\\result\\hd_java_files.txt"; 
    
    String non_logged_file_path = "E:\\Sangeeta\\Research\\L6-CROSS-IF\\result\\hd_non_log_if.txt";
   ...
   //*/
	...
	{				    
		Hadoop_Training6_IF demo = new Hadoop_Training6_IF();
...
public void ast_prser(String file_name)
	{
		try
		{
			...
			rawContent = Hadoop_Training6_IF.readFileToString(file_name);
